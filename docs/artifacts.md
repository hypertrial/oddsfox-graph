...
- `propositions.parquet`, `relation_candidates.parquet`,
  `logic_edges.parquet`, and `rejected_edges.parquet`. WC2026 proposition rows
  additionally carry authoritative team, stage, normalized progression level,
  direction, progression meaning/polarity, opposite token, market/team status,
  volume, and optional `market_close_time`.
