...
def build_parser() -> argparse.ArgumentParser:
    ...
    _add_discovery_arguments(qualify)
    ...
    doctor.add_argument("--cache-dir", required=True, type=Path)
    doctor.add_argument("--compute-profile", required=True, type=Path)
...
def _add_runtime_arguments(parser: argparse.ArgumentParser) -> None:
    parser.add_argument("--primary-model-manifest", required=True, type=Path)
    parser.add_argument("--verifier-model-manifest", required=True, type=Path)
