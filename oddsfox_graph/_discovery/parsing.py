...
def validate_parsed_market(source: SourceMarket, parsed: ParsedMarket) -> None:
    ...
    for field, value in (
        ...
        ("canonical_team_name", source.team_name),
        ("stage_key", source.stage_key),
        ("stage_rank", source.stage_rank),
        ("market_direction", source.market_direction),
        ("progression_outcome_label", source.progression_outcome),
        ("market_status", source.market_status),
        ("is_still_alive", source.is_still_alive),
    ):
...
def proposition_row(
    ...
    return {
        ...
        "is_progression": source.is_progression,
