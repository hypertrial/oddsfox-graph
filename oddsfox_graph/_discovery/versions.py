...
CANDIDATE_STATE_VERSION = "candidate-components-v6"
EXECUTION_PLAN_VERSION = "execution-plan-v5"
PUBLICATION_VERSION = "discovery-publication-v6"
...
RELEASE_FIXTURE_SCHEMA_VERSION = "discovery-release-fixture-v5"
